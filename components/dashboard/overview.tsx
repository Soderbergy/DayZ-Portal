  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-muted-foreground">
        Welcome to your DayZ Portal dashboard. Here's an overview of your servers and recent activity.
      </p>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">2 running, 1 restarting</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div key={i} className="flex items-center gap-4">
                      ...
                      <div className="flex-1 space-y-1">
                        <p className="text-sm font-medium leading-none">Server restart scheduled</p>
